    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
                <i class="bi bi-box-seam"></i><span>Keuangan</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
            <ul id="components-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
                <li>
                    ...
                    <a class="{{ request()->routeIs('expenses') ? 'active' : '' }}" href="{{ route('expenses') }}">
        ...
        @endif
        <li class="nav-item">
            <a class="nav-link collapsed" href="{{ route('transaction_history') }}">
