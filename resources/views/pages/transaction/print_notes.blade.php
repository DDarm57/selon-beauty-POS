            ...
            <div class="items">
                @foreach ($transaction_details as $item)
                    ...
                    <div style="display: flex; justify-content: space-between;">
                        <p>Rp.{{ number_format($item->price_product) }} {{ $item->qty }}x</p>
                        <p>Rp.{{ number_format($item->total_product_price) }}</p>
                    </div>
                @endforeach
            </div>
            <p class="total">Total : Rp. {{ number_format($transaction->total_price) }}</p>
