                                ...
                                <table class="table table-striped" style="white-space: nowrap;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>Rp. {{ number_format($item->total_product_price) }}</td>
                                            @php
                                            $total_potongan = $item->total_product_price - $item->total_product_price_after_discount;
                                            @endphp
                                            <td>Rp. {{ number_format($total_potongan) }}</td>
                                            <td>Rp. {{ number_format($item->total_product_price_after_discount) }}</td>
                                            @if ($transaction->role == 1)
                                            <td>
